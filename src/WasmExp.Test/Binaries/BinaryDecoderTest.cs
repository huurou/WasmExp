  ...
  (type (func (result i32))))
        */
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(module.TypeSection.FuncTypes[0].Parameters.ValTypes, Is.EquivalentTo(new ValueType[] { Type.I32, Type.F32 }));
            Assert.That(module.TypeSection.FuncTypes[0].Results.ValTypes, Is.EquivalentTo(new ValueType[] { Type.I64, Type.F64 }));
            Assert.That(module.TypeSection.FuncTypes[1].Parameters.ValTypes, Is.EquivalentTo(new[] { Type.I32 }));
            Assert.That(module.TypeSection.FuncTypes[1].Results.ValTypes, Is.Empty);
            Assert.That(module.TypeSection.FuncTypes[2].Parameters.ValTypes, Is.Empty);
            Assert.That(module.TypeSection.FuncTypes[2].Results.ValTypes, Is.EquivalentTo(new[] { Type.I32 }));
        });
    }
